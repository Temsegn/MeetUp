export const AUTH_ASSETS = {
  ...
  user: '/auth/icon-user.svg',
  building: '/auth/icon-building.svg',
  createAccount: '/auth/icon-create-account.svg',
  signIn: '/auth/icon-signin.svg',
  workSmarter: '/auth/icon-work-smarter.svg',
  stayOrganized: '/auth/icon-stay-organized.svg',
  collaborate: '/auth/icon-collaborate.svg',
  /** Sign-up promo features (Figma 16:956) */
